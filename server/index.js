...
//Database connection
//make sure to change the connection below with your connection
//const connectString = "mongodb+srv://user1:userpw@cluster0.4g0eqmc.mongodb.net/dpostITDb?appName=Cluster0";
const connectString = `mongodb+srv://${ENV.DB_USER}:${ENV.DB_PASSWORD}@${ENV.DB_CLUSTER}/${ENV.DB_NAME}?appName=Cluster0`;
...
//api for saving data from register component to the userInfos collection
...
//api for like and dislike using PUT (updating)
